...
- 実行前に ${CLAUDE_SKILL_DIR}/wd-cc-tracker.exp.md が存在すれば読み、前回チェックしたバージョンや見落としパターンを確認する
- 実行後、分類の迷い・新たなキーワードパターン・見落としの教訓があれば ${CLAUDE_SKILL_DIR}/wd-cc-tracker.exp.md に追記する
